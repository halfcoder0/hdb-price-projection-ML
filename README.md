...
- Data - Datasets for model train-test
- Images - Data Analysis
- data_analysis.ipynb - Data Analysis Notebook
- get_coords_of_amenities.py - Python Script to get coordinate of amenities
- get_coords_of_flat.py - Python Script to get coordinates of flats
- model_training_and_ablation.ipynb - Notebook for training & ablation of models
...
1. **MRT Stations**: OpenStreetMap
2. **Bus Stops**: OpenStreetMap
3. **Schools**: OpenStreetMap
4. **Shopping Malls**: OpenStreetMap
5. **Hawker Centres**: OpenStreetMap
6. **Wet Markets**: OpenStreetMap
...
| Metrics  | R<sup>2</sup> | MAE  | RMSE |
|----------|:-------------:|:----:|:----:|
| Training | 0.9124 ± 0.0016 | 43,192 ± 231 | 55,429 ± 357 |
| Validation | 0.9130 | 43,083.99 | 55,196.38 |
| Test | 0.9140 | 43,053.36 | 55,099.01 |
